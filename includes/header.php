        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-3">
                    ...
                    <div class="flex flex-col">
                        <span class="text-sm md:text-base font-bold leading-tight">
                            <span style="color: #b91c1c;">Anthem</span> <span
                                style="color: #1e3a8a;">International</span> <span style="color: #b91c1c;">School</span>
                        </span>
                    </div>
                </a>
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <!-- Search Icon -->
                    <button onclick="toggleSearch()" class="text-gray-700 hover:text-navy transition"
                        aria-label="Search">
                ...
                <!-- Mobile Menu Button -->
                <button onclick="toggleMobileMenu()" class="lg:hidden text-navy hover:text-maroon"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden">
            <div class="bg-gradient-to-r from-navy to-blue-600 p-6 text-white">
                <div class="flex justify-between items-center">
                    ...
                    <button onclick="toggleSearch()" class="text-white hover:text-gold transition"
            ...
            <div class="p-6">
                <input type="text" id="searchInput" placeholder="Search for toppers, staff, announcements..."
                    class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-navy focus:border-transparent"
                    onkeyup="performSearch()" aria-label="Search input">
