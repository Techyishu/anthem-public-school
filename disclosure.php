                            ...
                            <?php foreach ($docs as $doc): ?>
                                <div
                                    ...
                                    <div class="p-6">
                                        ...
                                        <?php else: ?>
                                            <button
                                                class="block w-full bg-gray-100 text-gray-500 text-center py-3 px-6 rounded-lg cursor-not-allowed font-semibold"
                                                disabled>
                ...
                <div class="md:flex items-center justify-between">
                    <div class="mb-6 md:mb-0">
                        ...
                        <p class="text-gray-600">
                            For any queries regarding these documents, please feel free to contact our administration
                            office.
                        </p>
                    </div>
                    <a href="contact.php"
